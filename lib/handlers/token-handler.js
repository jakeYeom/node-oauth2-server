...
var grantTypes = {
  authorizationCode: require('../grant-types/authorization-code-grant-type'),
  client_credentials: require('../grant-types/client-credentials-grant-type'),
  password: require('../grant-types/password-grant-type'),
  refreshToken: require('../grant-types/refresh-token-grant-type')
};
...
TokenHandler.prototype.handleGrantType = function(request, client) {
  ...
  if (!_.has(this.grantTypes, grantType)) {
    throw new UnsupportedGrantTypeError('Unsupported grant type: `grantType` is invalid');
  }
